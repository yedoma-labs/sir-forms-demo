...
export async function submitContactForm(
  ...
  if (isDemoMode) {
    actionLogger.info('Demo mode: Form submission', { data: result.data, apiUrl, action: 'submitContactForm' })
...
export async function subscribeNewsletter(
  ...
  actionLogger.info('Newsletter subscription', { email: result.data.email, action: 'subscribeNewsletter' })
